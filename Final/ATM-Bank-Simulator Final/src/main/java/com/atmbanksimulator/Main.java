...
public class Main extends Application {
    ...
    public void start(Stage window) {
        ...
        // --- Added: one test account for each new account type ---
        // These let us test the StudentAccount (daily limit), PrimeAccount (overdraft),
        // and SavingsAccount (interest) without having to create them using the UI
        bank.addBankAccount(new StudentAccount("10003","33333", 100));
        bank.addBankAccount(new PrimeAccount("10004","44444", 50));
        bank.addBankAccount(new SavingsAccount("10005","55555", 200));

        // Test for create new account feature
        bank.createAccount("99999", "12345", "student");
